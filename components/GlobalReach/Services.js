                    ...
                    <Container className="pb-lg-4 mb-md-5 mb-4">
                        <Row className="align-items-center mb-4">
                            ...
                            <Col lg="3" md="4" className="mt-4 mt-sm-0 text-sm-right pt-2 pt-sm-0">
                                <Link href="/" ><a className="btn btn-outline-primary">Read more <i className="mdi mdi-chevron-right"></i></a></Link>
                            </Col>
                        </Row>
                                    ...
                                    <Col lg="4" md="6" xs="12" className="mt-5 pt-3" key={key}>
                                        <div className="features">
                                            ...
                                            <div className="content mt-4">
                                                ...
                                                <a href={feature.link} className="text-success">Read more <i className="mdi mdi-chevron-right"></i></a>
                                            </div>
                                        </div>
                                    </Col>
                                )
