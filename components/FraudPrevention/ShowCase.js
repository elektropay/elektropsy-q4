                ...
                <section className="section pt-0 bg-light">
                    <Container>
                        ...
                        <Row className="align-items-center">
                            <Col lg="5" md="6" >
                                <Image src={app1} className="img-fluid mx-auto d-block" alt="" />
                            </Col>
                            ...
                            <Col lg={7} md={6} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="section-title ms-lg-5">
                                    ...
                                    <a href="/" className="mt-3 text-primary">Find Out More <i className="mdi mdi-chevron-right"></i></a>
                                </div>
                            </Col>
                        </Row>
                    </Container>
                            ...
                            <Col xs="12">
                                <TabContent activeTab={this.state.activeTab}>
                                    <TabPane tabId="1">
                                        <Row className="align-items-center">
                                            <Col md={6}>
                                                <Image src={app2} className="img-fluid mx-auto d-block" alt="" />
                                            </Col>
                                    ...
                                    <TabPane tabId="2">
                                        <Row className="align-items-center">
                                            <Col md={6}>
                                                <Image src={app3} className="img-fluid mx-auto d-block" alt="" />
                                            </Col>
                                    ...
                                    <TabPane tabId="3">
                                        ...
                                        <Row className="align-items-center">
                                            <Col md={6}>
                                                <Image src={app4} className="img-fluid mx-auto d-block" alt="" />
                                            </Col>
