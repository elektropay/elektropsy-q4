                                ...
                                this.state.features.map((feature, key) =>
                                    <Col md={4} key={key}>
                                        <div className="course-feature text-center position-relative d-block overflow-hidden bg-white rounded p-4 pt-5 pb-5">
                                            <div className="icon">
                                                <Image src={feature.icon} className="avatar avatar-small" height="55" alt="" />
                                            </div>
                                            <h4 className="mt-3"><Link href={feature.link} ><a className="title text-dark"> {feature.title}</a></Link></h4>
                                            <p className="text-muted">{feature.desc} </p>
                                            <a href={feature.link} className="text-primary read-more"> Read More <i className="mdi mdi-chevron-right"></i></a>
                                            {/* <Image src={feature.icon} className="full-img" height="300" alt="" /> */}
                                        </div>
                                    </Col>
                                )
                            }
