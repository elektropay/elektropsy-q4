                        ...
                        <Col lg="4" md="6" xs="12" key={key} className="mt-4 pt-2">
                            <div className="courses-desc position-relative overflow-hidden rounded border">
                                <div className="position-relative d-block overflow-hidden">
                                    <Image src={course.image} className="img-fluid rounded-top mx-auto" alt=""/>
                                    <div className="overlay-work"></div>
                                    <Link href="/" ><a className="text-white h6 preview">Preview Now <i className="mdi mdi-chevron-right"></i></a></Link>
                                </div>
                                <div className="content p-3">
                                    <h5><Link href="/"><a  className="title text-dark">{course.title}</a></Link></h5>
                                    <div className="rating">
                                        <ul className="list-unstyled mb-0">
                                            <li className="list-inline-item me-2 mt-2">
                                                <StarRatings
                                    ...
                                    <div className="fees">
                                        <ul className="list-unstyled float-end mb-0">
                                ...
                                <div className="collection">
                                    <Link href="/"><a><i className="mdi mdi-heart h5"></i></a></Link>
                                </div>
                            </div>
                        </Col>
                    )
