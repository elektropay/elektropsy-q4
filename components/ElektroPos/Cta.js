...
class Cta extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <section className="section bg-cta" style={{ background: `url(${bg02.src})`, backgroundPosition: "center center" }} id="cta">
                        ...
                        <Row className="justify-content-center">
                            <Col xs="12" className="text-center">
                                <div className="section-title">
                                    ...
                                    <a onClick={this.openModal} href="/" className="play-btn border border-light mt-2 video-play-icon">
