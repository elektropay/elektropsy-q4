                    ...
                    <Container>
                        <Row>
                            <ul className="col container-filter list-unstyled categories-filter text-center" id="filter">
                                <li className="list-inline-item"><a  to="#" onClick={() => this.setCategory("All")} className={this.state.displayCategory === "All" ? "categories border d-block text-dark rounded active" : "categories border d-block text-dark rounded" }>All</a></li>
                                <li className="list-inline-item"><a to="#" onClick={() => this.setCategory("Branding")} className={this.state.displayCategory === "Branding" ? "categories border d-block text-dark rounded active" : "categories border d-block text-dark rounded" } >Branding</a></li>
                                <li className="list-inline-item"><a to="#" onClick={() => this.setCategory("Designing")} className={this.state.displayCategory === "Designing" ? "categories border d-block text-dark rounded active" :"categories border d-block text-dark rounded"  }>Designing</a></li>
                                <li className="list-inline-item"><a  to="#" onClick={() => this.setCategory("Photography")} className={this.state.displayCategory === "Photography" ?  "categories border d-block text-dark rounded active" :  "categories border d-block text-dark rounded" } >Photography</a></li>
                                <li className="list-inline-item"><a to="#" onClick={() => this.setCategory("Development")} className={this.state.displayCategory === "Development" ?"categories border d-block text-dark rounded active"  : "categories border d-block text-dark rounded" } >Development</a></li>
                            </ul>
                        </Row>
                    </Container>
                            ...
                            .map(({ category, title, image, author, date }, key) => (
                                <Col lg={3} md={6} key={key} className="spacing designing">
                                    <div className="work-container position-relative d-block overflow-hidden rounded mt-3">
                                        <a className="mfp-image d-inline-block" to="#" onClick={(event) => {event.preventDefault(); this.setState({ isOpen: true, photoIndex : key })}} title="" >
                                            <Image src={image} className="img-fluid rounded" alt="work" />
                                            <div className="overlay-work"></div>
                                        </a>
                                        <div className="content personal-port">
                                            <a to="#" className="title text-white d-block font-weight-bold">{title}</a>
                        ...
                        <Row className="justify-content-center">
                            <Col xs="12" className="text-center">
                                <div className="section-title">
                                    <h4 className="title mb-4">Lets talk about your portfolio</h4>
                                    ...
                                    <div className="mt-3">
                                        <Link href="/" ><a className="btn btn-primary">Get Started Now</a></Link>
                                    </div>
                                </div>
                            </Col>
                        </Row>
