                                        ...
                                        this.state.currencies.map((currency, key) =>
                                            <tr key={key}>
                                                ...
                                                <th>
                                                    ...
                                                    <Image src={currency.image} className="float-start" height="50" width="50" alt=""/>
                                                    <p className="mt-2 mb-0 font-weight-normal ms-3 h5">{currency.name} <span className="text-muted h6">{currency.subname}</span> </p>
                                                    </div>
                                                </th>
                                                <td>₹ {currency.price}</td>
                                                <td className={ currency.change.charAt(0) === "+" ? "text-success" : "text-danger"}>{currency.change}</td>
                                                <td><Link href={currency.link} ><a className="btn btn-primary">Buy</a></Link></td>
                                            </tr>                                        
                                        )
                                    }
                                </tbody>
