                ...
                <Row className="align-items-center">
                    <Col lg={{size :5, order :1}} xs={{order:2}}  className="mt-4 pt-2 mt-lg-0 pt-lg-0">
                        <div className="section-title me-lg-4">
                            ...
                            <p className="para-desc text-muted">Use our extensive global payments network and technologies to access global markets.</p>
                            ...
                            <Row>
                                    ...
                                    this.props.facilities.map((facility, key) =>
                                        <Col xs="12" key={key}>
                                            <div className="pb-0 pt-4">
                                                <h2><i className={"mdi "+ facility.icon + " float-left me-3 mt-3 text-primary"}></i></h2>
                                ...
                                <Link href=""><a className="btn btn-dark">Find out how</a></Link>
                                </Col>
                            </Row>
                        </div>
                    </Col>
                    ...
                    <Col lg={{size:7, order:2}} xs={{order:1}}>
                        <div className="saas-feature-shape-right position-relative">
                            <Image src={this.props.image2} className="img-fluid mx-auto d-block rounded" alt=""/>
                        </div>
                    </Col>
                </Row>
            </Container>
            <Container className="pb-5 mb-md-5 mt-100 mt-60 mb-5">
                <Row className="align-items-center mb-5">
                    <Col lg="7">
                        <div className="saas-feature-shape-left position-relative">
                            <Image src={this.props.image1} className="img-fluid mx-auto d-block rounded" alt=""/>
                        </div>
                    </Col>
                            ...
                            >
                                {
                                    this.props.testimonials.map((testimonial, key) =>
                                        <div key={key} className="customer-testi py-3">
                                            <Image src={testimonial.image} style={{height:65, width:65}} className="img-fluid avatar avatar-small rounded-pill shadow" alt=""/>
