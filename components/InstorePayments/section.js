                                ...
                                <Row className="align-items-center">
                                    <Col lg="6" md="7">
                                        <div className="title-heading mt-4">
                                            ...
                                            <div className="mt-4">
                                                <Link href="/" ><a className="btn btn-outline-primary rounded"><i className="mdi mdi-google-my-business mr-1"></i>Make Your Shop</a></Link>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col lg="6" md="5" className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                                        <div className="position-relative">
                                            <Image src={busi01} className="rounded img-fluid mx-auto d-block" alt="" />
                                            <div className="play-icon">
                                                <Link href="/" ><a onClick={this.openModal} className="play-btn video-play-icon">
                                                    <i className="mdi mdi-play text-primary rounded-pill bg-white shadow"></i></a>
                                                </Link>
                                            </div>
                                        </div>
                                    </Col>
