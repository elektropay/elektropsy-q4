...
//Import Images
// import modern01 from '../../images/modsern01.jpg';
...
class Section extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <section className="bg-half-170 d-table w-100" style={{ background: `url(${modern01.src})center center` }} id="home">
                {/* <section className="bg-half-170 d-table w-100 mobile-payments"  id="home"> */}
                        <div className="bg-overlay"></div>
                            <Container>
                                <Row className="align-items-center mt-md-5 position-relative z-index-9">
                                                ...
                                                <Row>
                                                    <Col md={12}>
                                                        <FormGroup className="position-relative">
                                                            ...
                                                            <i className="mdi mdi-account ms-3 icons"></i>
                                                    ...
                                                    <Col md={12}>
                                                        <FormGroup className="position-relative">
                                                            ...
                                                            <i className="mdi mdi-email ms-3 icons"></i>
                                                    ...
                                                    <Col md={12}>
                                                        <FormGroup className="position-relative">
                                                            ...
                                                            <i className="mdi mdi-key ms-3 icons"></i>
                                                    ...
                                                    <Col lg={12} className="mt-4 text-center">
                                                        ...
                                                        <ul className="list-unstyled social-icon mb-0 mt-3">
                                                            <li className="list-inline-item me-1"><Link href="/" ><a className="rounded"><i className="mdi mdi-facebook" title="Facebook"></i></a></Link></li>
                                                            <li className="list-inline-item me-1"><Link href="/" ><a className="rounded"><i className="mdi mdi-google-plus" title="Google"></i></a></Link></li>
                                                            <li className="list-inline-item"><Link href="/" ><a className="rounded"><i className="mdi mdi-github-circle" title="Github"></i></a></Link></li>
                                                        </ul>
                                                    </Col>
                                                </Row>
                                            </Form>
                                    ...
                                    <Col lg={{size:7, offset:1}} md={{size:6, order:2}} xs={{order:1}}>
                                        <div className="title-heading mt-4">
                                            ...
                                            <div className="watch-video mt-4 pt-2">
                                                <Link href="/" ><a  className="btn btn-primary mb-2 me-2">Get Started</a></Link>
                                                <a  href="/" onClick={this.openModal} className="video-play-icon watch title-dark text-light mb-2"><i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-pill text-white title-dark position-relative play play-iconbar"></i> WATCH VIDEO</a>
