                        ...
                        <Row className="align-items-center">
                            <Col lg="5" md="5">
                                <div className="position-relative">
                                    ...
                                    <div className="play-icon">
                                        <a to="#" onClick={this.openModal} className="play-btn video-play-icon">
                            ...
                            <Col lg="7" md="7" className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                                ...
                                <SectionTitleLeft
                                    ...
                                    class = "mdi-18px h4 me-2"
                                />
                                    <Link href="/"><a  className="btn btn-primary mt-3">Buy Now <i className="mdi mdi-chevron-right"></i></a></Link>
                                </div>
                            </Col>
                        </Row>
                    </Container>
                    ...
                    <Container className="mt-100 mt-60">
                        ...
                        <Row className="justify-content-center">
                            <Col xs="12" className="text-center">
                                <Link href="/" ><a className="btn btn-primary">See More <i className="mdi mdi-arrow-right"></i></a></Link>
                            </Col>
                        </Row>
                    </Container>
