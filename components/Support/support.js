                                    ...
                                    <Row className="align-items-center">
                                        <Col md={{size:6, order:1}} xs={{order:1}} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                            <div className="section-title me-md-4">
                                                ...
                                                <p className="text-muted" data-aos="fade-up" data-aos-duration="1400">CRM systems start by collecting a customers website, email, telephone, social media data, and more, across multiple sources and channels. It may also automatically pull in other information, such as recent news about the companys activity, and it can store personal details, such as a clients personal preferences on communications.</p>
                                                <div className="mt-4" data-aos="fade-up" data-aos-duration="1800">
                                                    <a href="/" className="text-primary p-1 px-2 shadow rounded me-3">Read More <i className="mdi mdi-chevron-right"></i></a>
                                                   <a href="/"  className="text-warning p-1 px-2 shadow rounded">Blogs</a>
                                                </div>
                                            </div>
                                        </Col>   

                                        <Col md={{size:6, order:2}} xs={{order:1}}>
                                            <Image src={img2} data-aos="fade-up" data-aos-duration="1400" className="img-fluid mx-auto d-block shadow rounded" alt=""/>
                                        </Col>  
                                    </Row>                           
                                </TabPane>
