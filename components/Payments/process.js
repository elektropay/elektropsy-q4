                            ...
                            <div>
                                {
                                    this.state.paymentMethods.map((paymentMethod, key) =>
                                        <a href="" key={key}> 
                                        <Image src={paymentMethod.icon} width={65} height={65} className="img-fluid avatar avatar-small mr-3 rounded-pill shadow" id={paymentMethod.id} alt=""/>
                ...
                <Container className="mt-100 mt-60">
                    <Row className="justify-content-center">
                        <Col xs="12" className="text-center">
                            ...
                            {/* <Image src={sellerOrder} alt="" layout="responsive" width={1000} height={540} className="position-relative img-fluid mx-auto d-block"  style={{ zIndex : "1"}}/> */}
                            <Image src={sellerOrder} width="1000" height="540" className=" img-fluid mx-auto d-block"   style={{ zIndex : "1"}}/>
