                            ...
                            <div className="rounded border bg-light shadow">
                                ...
                                <div className="p-4">
                                    ...
                                    <ul className="feature list-inline">
                                        <li className="h5 font-weight-normal"><i className="mdi mdi-check-decagram text-primary me-2"></i>Transparent payouts</li>
                                        <li className="h5 font-weight-normal"><i className="mdi mdi-check-decagram text-primary me-2"></i>Deposit tagging</li>
                                        <li className="h5 font-weight-normal"><i className="mdi mdi-check-decagram text-primary me-2"></i>Control payout timing</li>
                                        <li className="h5 font-weight-normal"><i className="mdi mdi-check-decagram text-primary me-2"></i>24×7 support</li>
                                    </ul>

                                    <Link href="" ><a className="btn btn-primary btn-block mt-4 pt-2 w-100">Payment Now</a></Link>
                                </div>
                            </div>
                        </Col>
