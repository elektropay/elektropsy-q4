                        ...
                        <Row className="justify-content-center">
                            <Col lg="10">
                                <div className="title-heading text-center mt-4">
                                    <Image src={card} className="avatar avatar-md-sm image-width"  alt="" height={45} width={45} />
                                    ...
                                    <p className="para-desc mx-auto text-muted">Launch your start-up and benefit from our expertise on designing and managing conversion centered bootstrap4 html page.</p>
                                    <div className="mt-4 pt-2">
                                        <Link href="" ><a className="btn btn-primary">Get Started <i className="mdi mdi-chevron-right"></i></a></Link>
                                    </div>
                                </div>
                                ...
                                <Row className="justify-content-center mt-lg-4 mt-3">
                                    <Col md="6" className="mt-4 pt-2">
                                        <div className="bg-light p-4 py-5 rounded shadow d-block">
                                            <Image src={master} height="60" width={96} className="text-right" alt=""/>
                                            <div className="mt-4">
                                                <h5 className="">•••• •••• •••• 4559</h5>
                                                <div>
                                                    <h6 className="mb-0 float-right">Exp: <span className="text-muted">10/22</span></h6>
                                                    <p className="h6 text-muted mb-0">Richard Rowe</p>
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col md="6" className="mt-4 pt-2">
                                        <div className="bg-info p-4 py-5 rounded shadow d-block">
                                            <Image src={rupay} height="60" width={108} className="text-right" alt=""/>
                                            <div className="mt-4">
                                    ...
                                    <Col md="6" className="mt-4 pt-2">
                                        <div className="bg-light p-4 py-5 rounded shadow d-block">
                                            <Image src={paypal} height="60" width={150} className="text-right" alt=""/>
                                            <div className="mt-4">
