                ...
                <section className="section">
                    <Container>
                        <Row className="align-items-center">
                            <Col md="6">
                                <Image src={analyzeReport4} className="me-md-4" alt="" />
                            </Col>
                            ...
                            <Col md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="section-title me-lg-5">
                                    ...
                                    <Link href="/"><a className="btn btn-outline-primary">Start Now <i className="mdi mdi-chevron-right"></i></a></Link>
                                </div>
                            </Col>
                        </Row>
                    </Container>
                                ...
                                >
                                    {
                                        this.state.clients.map((client, key) =>
                                            <div key={key} className="customer-testi me-2 ml-2 text-center p-4 rounded border">
                                                <Image src={client.image} width={300} height={25} className="img-fluid avatar avatar-ex-sm mx-auto" alt=""/>
