                                    ...
                                    <Col lg={7} md={7}>
                                        <div className="title-heading mt-4">
                                            ...
                                            <div className="watch-video mt-4 pt-2">
                                                <Link href="page-services" ><a className="btn btn-primary mb-2 me-2"> Our Services </a></Link>
                                                <a  onClick={this.openModal} to="#" className="video-play-icon watch text-dark mb-2"><i className="mdi mdi-play play-icon-circle text-center d-inline-block me-2 rounded-pill title-dark text-white position-relative play play-iconbar"></i> WATCH VIDEO</a>
