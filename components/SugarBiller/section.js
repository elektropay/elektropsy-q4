...
class Section extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <section className="bg-home d-flex align-items-center" style={{ background: `url(${bg01.src}) center center`, height:"auto" }} id="home">
                                    ...
                                    <Col md="9" className="text-center mt-0 mt-md-5 pt-0 pt-md-5">
                                        <div className="title-heading margin-top-100">
                                            ...
                                            <div className="watch-video mt-4 pt-2">
                                                <a  onClick={this.openModal} to="#" className="video-play-icon watch text-dark"><i className="mdi mdi-play play-icon-circle text-center d-inline-block me-2 rounded-pill title-dark text-white position-relative play play-iconbar"></i> WATCH VIDEO</a>
                                                <ModalVideo channel='youtube' isOpen={this.state.isOpen} videoId='L61p2uyiMSo' onClose={() => this.setState({isOpen: false})} />
                                            </div>
                                        </div>
                                        <div className="home-dashboard">
                                            <Image src={single01} alt="" className="img-fluid mover" />
                                        </div>
                                    </Col>
                                </Row>
                            </Container>
