                    ...
                    <Container>
                        <Row className="align-items-center">
                            <Col md="6">
                                ...
                                >
                                    <div><Image src={single01} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                    <div><Image src={single02} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                    <div><Image src={single03} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                    <div><Image src={single04} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                    <div><Image src={single05} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                    <div><Image src={single06} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                    <div><Image src={single07} id="main_src" className="img-fluid rounded" alt="alt" /></div>
                                </Slider>
                                ...
                                <Slider
                                    ...
                                    focusOnSelect={true}
                                >
                                <div><Image src={single01} className="img-fluid" alt=""/></div>
                                <div><Image src={single02}  className="img-fluid" alt=""/></div>
                                <div><Image src={single03}  className="img-fluid" alt=""/></div>
                                <div><Image src={single04}  className="img-fluid" alt=""/></div>
                                <div><Image src={single05} className="img-fluid" alt=""/></div>
                                <div><Image src={single06} className="img-fluid" alt=""/></div>
                                <div><Image src={single07}  className="img-fluid" alt=""/></div>
                                </Slider>
                            </Col>
