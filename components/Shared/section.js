...
class Section extends Component {
    render() {
        return (
            <React.Fragment>
                <section className="bg-home bg-primary d-flex align-items-center" style={{ background: `url(${bg1.src}) center center` }} id="home">
                                    ...
                                    <Col lg={12}>
                                        <div className="title-heading text-center mt-5 position-relative" style={{ zIndex: 1 }}>
                                            ...
                                            <div className="mt-4 pt-2">
                                                <Link href="/" ><a className="btn btn-success">Get Started</a></Link>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
