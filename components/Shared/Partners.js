            ...
            <React.Fragment>
                        <Row className="justify-content-center" id="partners">
                            <Col id="partner1" lg="2" md="2" xs="6" className="text-center">
                                <Image src={img1} className="avatar avatar-ex-sm" width={75} height={25} alt=""/>
                            </Col>

                            <Col id="partner2" lg="2" md="2" xs="6" className="text-center">
                                <Image src={img2} className="avatar avatar-ex-sm" width={75} height={25} alt=""/>
                            </Col>
                            
                            <Col id="partner3" lg="2" md="2" xs="6" className="text-center  mt-4 mt-sm-0">
                                <Image src={img3} className="avatar avatar-ex-sm" width={75} height={25} alt=""/>
                            </Col>
                            
                            <Col id="partner4" lg="2" md="2" xs="6" className="text-center  mt-4 mt-sm-0">
                                <Image src={img4} className="avatar avatar-ex-sm" width={75} height={25} alt=""/>
                            </Col>
                            
                            <Col id="partner5" lg="2" md="2" xs="6" className="text-center  mt-4 mt-sm-0">
                                <Image src={img5} className="avatar avatar-ex-sm" width={75} height={25} alt=""/>
                            </Col>
                            
                            <Col id="partner6" lg="2" md="2" xs="6" className="text-center  mt-4 mt-sm-0">
                                <Image src={img6} className="avatar avatar-ex-sm" width={75} height={25} alt=""/>
                            </Col>
                        </Row>
            </React.Fragment>
        );
