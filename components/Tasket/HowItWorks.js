                ...
                <section className="section bg-light">
                    <Container>
                        <Row className="align-items-center">
                            <Col lg={5} md={6}>
                                <Image src={hosting1} className="img-fluid" alt="" />
                            </Col>
                            ...
                            <Col lg={7} md={6} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                />
                                    <Link href="/" ><a className="btn btn-primary mt-3">Get Started <i className="mdi mdi-chevron-right"></i></a></Link>
                                </div>
                            </Col>
                        </Row>
                    </Container>
                    ...
                    <Container className="mt-100 mt-60">
                        <Row className="align-items-center">
                            ...
                            <Col lg={6} md={6} className="order-1 order-md-2">
                                <Image src={dealHend} className="img-fluid" alt="" />
                            </Col>
                        </Row>
                    </Container>
                    ...
                    <Container className="mt-100 mt-60">
                        <Row className="align-items-center">
                            <Col lg={5} md={6}>
                                <Image src={hosting2} className="img-fluid" alt="" />
                            </Col>
