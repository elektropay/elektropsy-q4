...
class Testi extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <section className="section" style={{ background: `url(${bg02.src}) center center`}}>
                                ...
                                >
                                    {
                                        this.state.clients.map((client, key) =>
                                            <div key={key} className="customer-testi text-center">
                                                ...
                                                <Image src={client.image} height={65} width={65} className="img-fluid avatar avatar-small  rounded-pill mx-auto shadow" alt="testimonial"/>
                                                </div>
                                            </div>
                                        )
                                    }
