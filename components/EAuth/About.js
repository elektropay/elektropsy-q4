                        ...
                        <Row className="align-items-center">
                            <Col md="6">
                                <div className="section-title">
                                    ...
                                    <h6 className="text-primary mb-4">I am Passionate Web Designer</h6>
                                    ...
                                    <div className="mt-4">
                                        <Link href="#contact" ><a className="btn btn-primary mouse-down"><i className="mdi mdi-phone"></i> Contact Me</a></Link>
                                    </div>
                                </div>
                            </Col>
                    ...
                    <Container className="mt-100 mt-60" id="portfolio">
                        ...
                        <Row>
                                ...
                                this.state.projects.map((project, key) =>
                                    <Col lg="4" md="6" key={key} className="mt-4 pt-2">
                                        <div className="work-container position-relative d-block overflow-hidden rounded">
                                            <a className="mfp-image d-inline-block" to="#" onClick={() => this.setState({ isOpen: true, photoIndex : key })} title="">
                                                <Image src={project.image} className="img-fluid rounded" alt="work" />
                                                <div className="overlay-work"></div>
                                            </a>
                                            <div className="content personal-port">
                                                <Link href="/" ><a className="title text-white d-block font-weight-bold">{project.title}</a></Link>
                            ...
                            <Col className="mt-4 pt-2">
                                <Link href="/" ><a className="btn btn-outline-primary">See More <i className="mdi mdi-chevron-right"></i></a></Link>
                            </Col>
                        </Row>
