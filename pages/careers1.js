                                ...
                                this.state.jobs.map((job, key) =>
                                    <Col key={key} lg="4" md="6" xs="12" className="mt-4 pt-2">
                                        <div className="job-box rounded shadow position-relative overflow-hidden">
                                            <div className="border-bottom">
                                                <div className="position-relative">
                                                    <Image src={full} className="img-fluid" alt=""/>
                                                    <div className="job-overlay bg-white"></div>
                                                </div>
                                                <h5 className="mb-0 position"><Link href="/job-detail"><a className="text-dark">{job.title}</a></Link>
                                            ...
                                            <div className="content position-relative p-4">
                                                <div className="firm-logo rounded-pill shadow bg-light text-center">
                                                    <Image src={job.cmpImage} width={65} height={65} className="avatar avatar-md-sm" alt=""/>
                                                </div>
                                                <div className="company-detail text-center mt-3">
                                                    <h5 className="mb-0 text-dark company-name"> {job.cmpName}</h5>
                                                    <p className="text-muted"><Link href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" ><a className="video-play-icon text-muted"><i className="mdi mdi-map-marker"></i> San Francisco</a></Link></p>
                                                </div>
                                                ...
                                                <Link href="/job-detail" ><a className="btn btn-outline-primary btn-block">Apply Now</a></Link>
                                            </div>
                                        </div>
                                    </Col>
                                )
