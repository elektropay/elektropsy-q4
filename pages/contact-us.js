                        ...
                        <Row>
                            <Col md={4}>
                                <div className="contact-detail text-center">
                                    <div className="icon">
                                        <Image src={bitcoin} width={65} height={65} className="avatar avatar-small" alt=""/>
                                    </div>
                                    <div className="content mt-3">
                                        ...
                                        <a href="/" onClick={this.callNumber} className="btn btn-outline btn-primary">Toll-Free: +1 800-566-6003</a>
                                    </div>  
                                </div>
                            </Col>
                            ...
                            <Col md={4} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="contact-detail text-center">
                                    <div className="icon">
                                        <Image src={Email} width={65} height={65} className="avatar avatar-small" alt="Elektropay" />
                                    </div>
                                    <div className="content mt-3">
                                        ...
                                        <a href="/" onClick={this.sendMail} className="btn btn-outline btn-primary">support@elektropay.com</a>
                                    </div>
                                </div>
                            </Col>
                            ...
                            <Col md={4} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="contact-detail text-center">
                                    <div className="icon">
                                        <Image src={location} width={65} height={65} className="avatar avatar-small" alt="Elektropay" />
                                    </div>
                                    <div className="content mt-3">
                    ...
                    <Container className="mt-100 mt-60">
                        <Row className="align-items-center">
                                            ...
                                            <Row>
                                                <Col md={6}>
                                                    <FormGroup className="position-relative">
                                                        ...
                                                        <Input name="name" id="name" type="text" className="form-control ps-5" placeholder="First Name :" required />
                                                    </FormGroup>
                                                </Col>
                                                <Col md={6}>
                                                    <FormGroup className="position-relative">
                                                        ...
                                                        <Input name="email" id="email" type="email" className="form-control ps-5" placeholder="Your email :" required />
                                                    </FormGroup>
                                                </Col>
                                                <Col md={12}>
                                                    <FormGroup className="position-relative">
                                                        <Label>Subject</Label>
                                                        <i className="mdi mdi-book ms-3 icons"></i>
                                                        <Input name="subject" id="subject" className="form-control ps-5" placeholder="Your subject :" required />
                                                    </FormGroup>
                                                </Col>
                                                <Col md={12}>
                                                    <FormGroup className="position-relative">
                            ...
                            <Col lg={7} md={6} className="order-1 order-md-2">
                                <Image src={contact} className="img-fluid" alt="Elektropay" />
                            </Col>
                        </Row>
                    </Container>
