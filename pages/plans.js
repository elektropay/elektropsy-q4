...
//Import components
import Section from '../components/Heros/plans'
                        ...
                        <Row>
                            ...
                            <Col md={6} xs="12" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="faq-container">
                                    ...
                                    <p className="answer text-muted ml-lg-4 pl-lg-3 mb-0">If the distribution of letters is random, the reader will not be distracted from making a neutral judgement on the visual impact</p>
                                </div>
                            </Col>
                            ...
                            <Col md={6} xs="12" className="mt-4 pt-2">
                                <div className="faq-container">
                                    ...
                                    <p className="answer text-muted ml-lg-4 pl-lg-3 mb-0">The most well-known which is said to have originated in the 16th century. Lorem Ipsum is composed in a pseudo-Latin language which more or less corresponds Latin.</p>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className="mt-md-5 pt-md-3 mt-4 pt-2 mt-sm-0 pt-sm-0 justify-content-center">
                            <div xs="12" className="text-center">
                                <div className="section-title">
                                    ...
                                    <a href="/" className="btn btn-primary mt-4">Contact us <i className="mdi mdi-arrow-right"></i></a>
                                </div>
                            </div>
                        </Row>
                    </Container>
