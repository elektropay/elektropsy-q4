                            ...
                            <Col lg={7} md={6} className="order-1 order-md-2">
                                <div className="title-heading ml-lg-4">
                                    ...
                                    <div className="contact-detail mt-3">
                                        <div className="icon mt-3 float-start">
                                            <i className="mdi mdi-email-variant text-muted mdi-36px me-3"></i>
                                        </div>
                                        <div className="content mt-3 overflow-hidden d-block">
                                            <h4 className="title font-weight-bold mb-0">Email</h4>
                                            <a href="/" onClick={this.sendMail} className="text-primary h6">contact@example.com</a>
                                        </div>
                                    </div>

                                    <div className="contact-detail mt-3">
                                        <div className="icon mt-3 float-start">
                                            <i className="mdi mdi-phone text-muted mdi-36px me-3"></i>
                                        </div>
                                        <div className="content mt-3 overflow-hidden d-block">
                                            <h4 className="title font-weight-bold mb-0">Phone</h4>
                                            <a href="/" onClick={this.callNumber} className="text-primary h6">+152 534-468-854</a>
                                        </div>
                                    </div>

                                    <div className="contact-detail mt-3">
                                        <div className="icon mt-3 float-start">
                                            <i className="mdi mdi-map-marker-outline text-muted mdi-36px me-3"></i>
                                        </div>
                                        <div className="content mt-3 overflow-hidden d-block">
                                            <h4 className="title font-weight-bold mb-0">Location</h4>
                                            <a href="//www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" className="video-play-icon h6 text-primary">View on Google map</a>
                                        </div>
                                    </div>
                                </div>
                            </Col>
