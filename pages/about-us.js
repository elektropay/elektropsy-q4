...
Elektropay was founded in 2018 by a team of passionate financial technology and payments executives to solve everyday problems that nearly all businesses experience: accepting and processing international payments. Hassle-free and without any hidden fees.
                                    ...
                                    <Link href="/contact-us" ><a className="btn btn-primary mt-3">Reach out<i className="mdi mdi-chevron-right"></i></a></Link>
                                </div>
                            </Col>
                            <Col lg={5} md={5} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                                <div className="position-relative">
                                    <Image src={about} className="rounded img-fluid mx-auto d-block" alt="" />
                                    <div className="play-icon">
                                        <a onClick={this.openModal}  to="#" className="play-btn video-play-icon">
                    ...
                    <SectionTitle title="Key Features" desc="that can provide everything you need to generate more conversations and less churn.." />
                        ...
                        <Row className="justify-content-center">
                            <Col className="text-center mt-4 pt-2">
                                <Link href="/payment-method" ><a className="btn btn-primary">See More <i className="mdi mdi-arrow-right"></i></a></Link>
                            </Col>
                        </Row>
                    </Container>
                </section>
                        ...
                        <Row className="justify-content-center">
                            <Col className="text-center">
                                <div className="section-title">
                                    ...
                                    <div className="mt-3">
                                        <Link href="/careers" ><a className="btn btn-primary mt-2 me-2" >Check Openings</a></Link>&nbsp;
